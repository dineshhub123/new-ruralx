export const SIZE_MASTER: any = {
  ...
  feature_phones: ["Standard"],
  tablets: ["32GB", "64GB", "128GB", "256GB"],

  // 💻 Computers & Laptops
  laptops: ["8GB RAM / 256GB SSD", "16GB RAM / 512GB SSD", "32GB RAM / 1TB SSD"],
  desktops: ["i3", "i5", "i7", "i9"],
  monitors: ["21\"", "24\"", "27\"", "32\""],
  keyboards: ["Wired", "Wireless", "Mechanical"],
  mice: ["Wired", "Wireless", "Gaming"],
  storage: ["500GB HDD", "1TB HDD", "256GB SSD", "512GB SSD", "1TB SSD"],
  printers: ["Inkjet", "Laser", "All-in-One"],

  // ⌚ Wearables
  smartwatches: ["40mm", "44mm", "46mm"],
  fitness_bands: ["Standard"],
  vr_headsets: ["Oculus", "HTC Vive", "PS VR"],

  // 🎧 Audio & Music
  headphones: ["Wired", "Wireless", "Gaming"],
  earbuds: ["Standard"],
  speakers: ["Portable", "Smart", "Home Theater"],
  soundbars: ["2.1", "3.1", "5.1"],

  // 🔌 Tech Accessories
  powerbanks: ["5000mAh", "10000mAh", "20000mAh"],
  chargers: ["USB-A", "USB-C", "Fast Charger"],
  mobile_cases: ["iPhone", "Samsung", "OnePlus", "Xiaomi"], // can be dynamic
  screen_protectors: ["Tempered Glass", "Matte", "Privacy"],
  memory_cards: ["32GB", "64GB", "128GB", "256GB"],
  hubs_docks: ["USB 3.0", "USB-C", "Thunderbolt"],

  // 📷 Cameras & Accessories
  cameras: ["DSLR", "Mirrorless"],
  action_cameras: ["GoPro", "DJI", "Sony"],
  camera_accessories: ["Lens", "Tripod", "Flash"],

  // 🏠 Smart Home & Gadgets
  smart_home: ["Alexa", "Google Home", "Smart Plug", "Smart Bulb"],
